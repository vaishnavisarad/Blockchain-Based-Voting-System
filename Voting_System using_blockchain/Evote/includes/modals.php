...
<div class="modal fade" id="feedbacksModal" tabindex="-1" role="dialog" aria-labelledby="VotepleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addFeebacks" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="VotepleModalLabel">Submit Feedbacks</h5>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <?php 
               $selMe = $conn->query("SELECT * FROM Voteinee_tbl WHERE exmne_id='$exmneId' ")->fetch(PDO::FETCH_ASSOC);
             ?>
