        ...
        <div class="app-main__inner">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header">Voteinee List
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            <tbody>
                              <?php 
                                $selExmne = $conn->query("SELECT * FROM Voteinee_tbl ORDER BY exmne_id DESC ");
                                if($selExmne->rowCount() > 0)
                                {
                                    while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                           ...
                                           <td>
                                               <a rel="facebox" href="facebox_modal/updateVoteinee.php?id=<?php echo $selExmneRow['exmne_id']; ?>" class="btn btn-sm btn-primary">Update</a>
