...
<br>
<span style="color:black;">Describe:</span><textarea name="code" rows="5" cols="40" value="." class="form-control"></textarea><br><br>
...
alert('Question Added to forum Succesfully!!');
</script>";
